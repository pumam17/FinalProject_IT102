Public Class frmAttendantsAddFlight
    Private Sub frmAttendantAddFlight_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        intSelectedAttendant = cboAttendants.SelectedValue
        ...
        VALUES (" & intNextPrimaryKey & ", '" & intSelectedAttendant & "', '" & intSelectedFlight & "')"
        ...
        CloseDatabaseConnection()
        Close()
        Dim frmAttendantsAddFlight As New frmAttendantsAddFlight
        frmAttendantsAddFlight.Show()
        Exit Sub
    End Sub
