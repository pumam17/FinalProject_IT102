Public Class frmPiPFlights
    Private Sub frmPiPFlights_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            lstResultSet.Items.Add("Past flights for selected pilot")
