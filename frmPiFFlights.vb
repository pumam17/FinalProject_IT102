Public Class frmPiFFlights
    Private Sub frmPiFFlights_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            objParam = cmdSelect.Parameters.Add("@intPilot_ID", OleDb.OleDbType.Integer)
            objParam.Direction = ParameterDirection.Input
            objParam.Value = strString
            drSourceTable = cmdSelect.ExecuteReader
            'loop through result set and display in Listbox
            lstResultSet.Items.Add("Future flights for selected pilot")
