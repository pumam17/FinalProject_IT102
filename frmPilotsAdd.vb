Public Class frmPilotsAdd
    Private Sub frmPilotsAdd_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        If blnValidation = True Then
            ...
            VALUES (" & intNextPrimaryKey & ", '" & strFirstName & "', '" & strLastName & "', '" & intEmployeeID & "', '" & dtmDateOfHire & "', '" & dtmDateOfTermination & "', '" & dtmDateOfLicense & "', '" & intPilotRoleID & "')"
            ...
            cmdAddLogin.CommandText = "EXECUTE uspAddEmployeeLogin " & intPKID & ", '" & strLogin & "', '" & strPassword & "', 'Pilot', " & intNextPrimaryKey
