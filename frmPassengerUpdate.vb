Public Class frmPassengerUpdate
    ...
    Private Sub frmPassengerUpdate_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            FROM TPassengers Where intPassengerID = " & strString
            ...
            txtUsername.Text = drSourceTable("strPassengerLoginID")
            txtPassword.Text = drSourceTable("strPassengerPassword")
            txtDOB.Text = drSourceTable("dtmPassengerDateOfBirth")
            '--------------------------------------------------------
    ...
    Private Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        If blnValidation = True Then
            ...
            cmdUpdatePassenger.CommandText = "EXECUTE uspUpdatePassenger " & strString & ", '" & strFirstName & "', '" & strLastName & "', '" & strAddress & "', '" & strCity & "', " & intState & ", '" & intZip & "', '" & intPhoneNumber & "', '" & strEmail & "', '" & strLogin & "', '" & strPassword & "', '" & dtmDOB & "'"
            ...
            MessageBox.Show(cmdUpdatePassenger.CommandText.ToString)
    ...
    Private Sub Get_And_Validate_Input(ByRef strFirstName As String, ByRef strLastName As String, ByRef strAddress As String, ByRef strCity As String, ByRef intZip As String, ByRef intPhoneNumber As String, ByRef strEmail As String, ByRef strLogin As String, ByRef strPassword As String, ByRef strDOB As String, ByRef blnValidation As Boolean)
